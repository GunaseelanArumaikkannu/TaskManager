...
public class ItemDetailFragment extends Fragment {
    ...
    public static ItemDetailFragment newInstance(String param1, String param2, String param3) {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        tv1.setText(mParam1);
        tv2.setText(mParam3);
        iv1.setImageBitmap(BitmapFactory.decodeFile(mParam2));
        hide.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                FragmentManager manager = getFragmentManager();
                Fragment fragment = manager.findFragmentByTag("ItemDetails");
